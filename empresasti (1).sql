...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2022 a las 19:10:58
...
ALTER TABLE `comentarios`
  ...
  ADD KEY `relacion15` (`id_receta`),
  ADD KEY `relacion16` (`id_plato`),
  ADD KEY `relacion17` (`id_menus`);
...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `relacion15` FOREIGN KEY (`id_receta`) REFERENCES `recetas` (`id`),
  ADD CONSTRAINT `relacion16` FOREIGN KEY (`id_plato`) REFERENCES `plato` (`id`),
  ADD CONSTRAINT `relacion17` FOREIGN KEY (`id_menus`) REFERENCES `menus` (`id`);
